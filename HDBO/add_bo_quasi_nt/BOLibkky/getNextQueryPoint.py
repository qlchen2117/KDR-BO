...
def get_next_query_pt(train_x: Tensor, train_y: Tensor, params, decomposition: List[Tensor], bounds: Tensor):
    ...
    for k in range(num_groups):
        ...
        candidate, acq_value = optimize_acqf(utility, curr_bounds.T, q=1, num_restarts=20, raw_samples=256)
    ...
    next_point_mean, next_point_std, _ = compute_comb_gp_output(next_point.unsqueeze(0), train_x, train_y, decomposition, ell, alpha, sigma_sms,
